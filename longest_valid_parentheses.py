...
class Solution:
    def longestValidParentheses(self, s):
        ...
        def max_paren(s, start, end, mem):
            ...
            # recusive case 1, check if entire string is valid, skip recursive case 2 if so
            if check_all(s, start, end):
            ...
            for i in range(start + 1, end):
                len_l, start_l, end_l = max_paren(s, start, i, mem)
                len_r, start_r, end_r = max_paren(s, i, end, mem)
